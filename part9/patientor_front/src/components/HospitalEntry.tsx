  ...
  return (
    <Box mt={2} textAlign="left" >
      ...
      <Box sx={{}}>
        ...
        <Typography style={{ color: 'red', marginTop: '0.5rem', marginLeft: '0.2rem', }} variant="h6">To be dicharged: {formatDate(entry.discharge.date)} (criteria: {entry.discharge.criteria})</Typography>
      </Box>
    </Box>
  );
};
